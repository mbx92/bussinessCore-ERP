...
class ERPModuleController extends Controller
{
    public function accounting(): Response
    {
        return $this->renderModule('Accounting', [
            ...
            ['title' => 'Cashflow Accounting', 'description' => 'Ringkasan arus kas dari invoice, POS, supplier, inventaris, anggota, dan expenses.', 'route' => 'erp.accounting.cashflow', 'icon' => 'arrows-right-left'],
            ...
            ['title' => 'Inventaris', 'description' => 'Catat pembelian inventaris/aset ke buku besar. Akun aset bisa dipilih, default Peralatan.', 'route' => 'erp.accounting.inventaris', 'icon' => 'archive-box'],
    ...
    public function projects(): Response
    {
        return $this->renderModule('Projects', [
            ['title' => 'Tipe Project', 'description' => 'Master tipe project, label, default, dan capability seperti board task atau budget item.', 'route' => 'erp.projects.project-types.index', 'icon' => 'tag'],
