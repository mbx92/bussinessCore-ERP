    ...
    <div class="space-y-5">
      <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div class="mt-2 flex flex-wrap items-center justify-between gap-3">
          <h1 class="text-3xl font-bold tracking-tight">Lead Management</h1>
        ...
        <p class="mt-2 text-sm text-base-content/70">
          Pusat data calon customer, sumber lead, status prospek, dan PIC follow-up.
        </p>
      </div>
      ...
      <div class="ocn-panel">
        <div class="ocn-panel__head">
          ...
          <p class="ocn-panel__desc">{{ (leads || []).length }} lead ditemukan. Klik Edit untuk ubah data.</p>
        </div>
